...
[_BASE] = LAYOUT(
    ...
    LSFT_T(KC_C), LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), LGUI_T(KC_G),     RGUI_T(KC_M),   RSFT_T(KC_N), RCTL_T(KC_O), LALT_T(KC_I), RSFT_T(KC_A),
    KC_Q,         KC_J,         KC_V,         RALT_T(KC_D), KC_K,             KC_X,           RALT_T(KC_H), KC_SLSH,      KC_COMM,      KC_DOT,
                                              MO(_SYM),     LT(_NUM, KC_SPC), LT(_NAV, KC_E), MO(_FN)
),

[_NUM] = LAYOUT(
    TO(_BASE),    C(KC_X),      C(KC_C),      C(KC_V),      XXXXXXX,          KC_LBRC,        KC_7,         KC_8,         KC_9,         KC_RBRC,
    KC_LSFT,      KC_LALT,      KC_LCTL,      KC_LSFT,      KC_LGUI,          KC_EQL,         KC_4,         KC_5,         KC_6,         KC_SCLN,
...
[_NAV] = LAYOUT(
    ...
    KC_HOME,      KC_LEFT,      KC_DOWN,      KC_RGHT,      KC_END,           KC_RGUI,        KC_RSFT,      KC_RCTL,      KC_LALT,      KC_RSFT,
...
[_SYM] = LAYOUT(
    ...
    KC_LSFT,      KC_LALT,      KC_LCTL,      KC_LSFT,      KC_LGUI,          KC_PLUS,        KC_DLR,       KC_PERC,      KC_CIRC,      KC_COLN,
...
[_FN] = LAYOUT(
    ...
    KC_F11,       KC_F4,        KC_F5,        KC_F6,        KC_DEL,           KC_RGUI,        KC_RSFT,      KC_RCTL,      KC_LALT,      KC_RSFT,
