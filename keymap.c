...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LT(_NUM, KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F),     KC_G,             XXXXXXX, XXXXXXX, KC_H,            RSFT_T(KC_J),      RCTL_T(KC_K), LALT_T(KC_L),   LT(_NAV, KC_QUOT),
    LT(_SYM, KC_Z),         RALT_T(KC_X), LGUI_T(KC_C), KC_V,             KC_B,             XXXXXXX, XXXXXXX, KC_N,            KC_M,              RGUI_T(KC_COMM), RALT_T(KC_DOT), LT(_FN, KC_SLSH),
...
[_SYM] = LAYOUT_planck_grid(
    ...
    XXXXXXX,      KC_LALT,      KC_LCTL,      KC_LSFT,          XXXXXXX,          XXXXXXX, XXXXXXX, KC_PLUS,         KC_DLR,            KC_PERC,      KC_CIRC,        KC_COLN,
    XXXXXXX,      KC_RALT,      KC_LGUI,      XXXXXXX,          XXXXXXX,          XXXXXXX, XXXXXXX, KC_PIPE,         KC_EXLM,           KC_AT,        KC_HASH,        KC_TILD,
...
[_NUM] = LAYOUT_planck_grid(
    ...
    XXXXXXX,      KC_LALT,      KC_LCTL,      KC_LSFT,          XXXXXXX,          XXXXXXX, XXXXXXX, KC_EQL,          KC_4,              KC_5,         KC_6,           KC_SCLN,
    XXXXXXX,      KC_RALT,      KC_LGUI,      XXXXXXX,          XXXXXXX,          XXXXXXX, XXXXXXX, KC_BSLS,         KC_1,              KC_2,         KC_3,           KC_GRV,
...
[_FN] = LAYOUT_planck_grid(
    ...
    KC_F11,       KC_F4,        KC_F5,        KC_F6,            XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,         KC_RSFT,           KC_RCTL,      KC_LALT,        XXXXXXX,
    KC_F10,       KC_F1,        KC_F2,        KC_F3,            XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX,           KC_RGUI,      KC_RALT,        XXXXXXX,
...
[_NAV] = LAYOUT_planck_grid(
    ...
    KC_PGDN,      KC_LEFT,      KC_DOWN,      KC_RGHT,          KC_PGDN,          XXXXXXX, XXXXXXX, XXXXXXX,         KC_RSFT,           KC_RCTL,      KC_LALT,        XXXXXXX,
    XXXXXXX,      C(KC_X),      C(KC_C),      C(KC_V),          XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX,           KC_RGUI,      KC_RALT,        XXXXXXX,
    XXXXXXX,      XXXXXXX,      XXXXXXX,      KC_TAB,           KC_SPC,           XXXXXXX, XXXXXXX, KC_ENT,          KC_BSPC,           XXXXXXX,      XXXXXXX,        XXXXXXX
)
